...
function Login() {
    return (
            ...
            >
                ...
                <Paper elevation={3} sx={{ p: 3, maxWidth: '400px', width: '100%', bgcolor: 'white', zIndex: 1, position: 'absolute', borderRadius: '10px' }}>
                    <Box display="flex" justifyContent="center" sx={{ mb: 2 }}>
                        <img src={polibatam} alt="polibatam" style={{ width: '320px', height: '103px' }} />
                    </Box>
                    <Typography display="flex" justifyContent="center" component="h1" variant="h5" color='grey' sx={{ fontWeight: 'bold', fontFamily: 'Sansita' }}>
                    ...
                    <Box component="form" sx={{ mt: 1 }}>
                        ...
                        <Button
                            ...
                            fullWidth
                            variant="contained"
                            sx={{ mt: 3, mb: 2, fontFamily: 'Sansita', backgroundColor: '#3691BE', '&:hover': { backgroundColor: '#2c7ba8', }  }}
                        >
                            Login
                        </Button>
                    </Box>
